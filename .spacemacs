...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(transpose-frame graphql-mode flycheck-joker)
...
you should place your code here."
  ...
  (global-set-key [C-M-down-mouse-1] (lambda (e)
                                       (interactive "e")
                                       (mouse-set-point e)
                                       (evil-toggle-fold)))

  (global-set-key (kbd "<f5>") 'tear-off-window)
  ...
  (global-set-key (kbd "C-c DEL") (lambda () (interactive) (just-one-space -1)))
